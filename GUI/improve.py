    ...
    for i in range(0,20):
        for coin in coins:
            if api["data"][i]["symbol"]==coin["symbol"]:
                ...
                amount_paid = Label(pycrypto,text="${0:.2f}".format(total_paid),bg="blue",fg="white",font="Lato 12",padx="2",pady="2",borderwidth=2,relief="groove") 
                amount_paid.grid(row=coin_row,column=3,sticky=N+S+E+W) 


                current_val = Label(pycrypto,text="${0:.2f}".format(current_value),bg="black",fg="white",font="Lato 12",padx="2",pady="2",borderwidth=2,relief="groove") 
                current_val.grid(row=coin_row,column=4,sticky=N+S+E+W)

                pl_coin = Label(pycrypto,text="${0:.2f}".format(pl_percoin),bg="blue",fg="white",font="Lato 12",padx="2",pady="2",borderwidth=2,relief="groove") 
                pl_coin.grid(row=coin_row,column=5,sticky=N+S+E+W) 

                totalpl = Label(pycrypto,text="${0:.2f}".format(total_pl_coin),bg="black",fg="white",font="Lato 12",padx="2",pady="2",borderwidth=2,relief="groove") 
