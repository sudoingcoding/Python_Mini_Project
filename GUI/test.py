    ...
    for i in range(0,20):
        for coin in coins:
            if api["data"][i]["symbol"]==coin["symbol"]:
                ...
                name = Label(pycrypto,text=api["data"][i]["symbol"],bg="black",fg="white",font="Lato 12",padx="2",pady="2",borderwidth=2,relief="groove") 
                name.grid(row=coin_row,column=0,sticky=N+S+E+W)

                Price = Label(pycrypto,text="${0:.2f}".format(api["data"][i]["quote"]["USD"]["price"]),bg="blue",fg="white",font="Lato 12",padx="2",pady="2",borderwidth=2,relief="groove") 
                Price.grid(row=coin_row,column=1,sticky=N+S+E+W)

                no_coins = Label(pycrypto,text=coin["price_per_coin"],bg="black",fg="white",font="Lato 12",padx="2",pady="2",borderwidth=2,relief="groove") 
                no_coins.grid(row=coin_row,column=2,sticky=N+S+E+W) 

                amount_paid = Label(pycrypto,text="${0:.2f}".format(total_paid),bg="blue",fg=font_color(float("{0:.2f}".format(pl_percoin))),font="Lato 12",padx="2",pady="2",borderwidth=2,relief="groove") 
                amount_paid.grid(row=coin_row,column=3,sticky=N+S+E+W) 


                current_val = Label(pycrypto,text="${0:.2f}".format(current_value),bg="black",fg=font_color(float("{0:.2f}".format(current_value))),font="Lato 12",padx="2",pady="2",borderwidth=2,relief="groove") 
                current_val.grid(row=coin_row,column=4,sticky=N+S+E+W)

                pl_coin = Label(pycrypto,text="${0:.2f}".format(pl_percoin),bg="blue",fg=font_color(float("{0:.2f}".format(pl_percoin))),font="Lato 12",padx="2",pady="2",borderwidth=2,relief="groove") 
                pl_coin.grid(row=coin_row,column=5,sticky=N+S+E+W) 

                totalpl = Label(pycrypto,text="${0:.2f}".format(total_pl_coin),bg="black",fg=font_color(float("{0:.2f}".format(total_pl_coin))),font="Lato 12",padx="2",pady="2",borderwidth=2,relief="groove") 
                totalpl.grid(row=coin_row,column=6,sticky=N+S+E+W) 

                coin_row+=1
    
    
    totalcv = Label(pycrypto,text="${0:.2f}".format(total_current_value),bg="black",fg="white",font="Lato 12",padx="2",pady="2",borderwidth=2,relief="groove")
    totalcv.grid(row=coin_row,column=4,sticky=N+S+E+W)

    
    totalpl = Label(pycrypto,text="${0:.2f}".format(total_pl),bg="black",fg="white",font="Lato 12",padx="2",pady="2",borderwidth=2,relief="groove")
    totalpl.grid(row=coin_row,column=6,sticky=N+S+E+W)

    api=""
    
    update = Button(pycrypto,text="Update",bg="orange",fg="white",command=my_portfolio,font="Lato 12",padx="2",pady="2",borderwidth=2,relief="groove")
